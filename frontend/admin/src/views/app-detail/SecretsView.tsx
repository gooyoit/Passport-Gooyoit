...
import { ActionButton, ChipButton, EmptyBlock } from "../../components/ui";
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3">
        ...
        <ActionButton variant="secondary" onClick={onRegenerate} className="text-brand border-brand/30 hover:bg-brand-light">
          <RefreshCw size={14} /> 生成新密钥
        </ActionButton>
      </div>
      {secrets.length === 0 ? (
        <EmptyBlock text="暂无密钥，请点击上方「生成新密钥」" />
      ) : (
